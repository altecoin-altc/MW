...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasterWin masterwin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  masterwin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded masterwin transaction") + "\n" +
                               "  masterwin-tx [options] -create [commands]   " + _("Create hex-encoded masterwin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded masterwin transaction
