...
/** Utility functions used by the MasterWin Qt UI.
 */
namespace GUIUtil
{
...
// Render MasterWin addresses in monospace font
...
// Parse "masterwin:" URI into recipient object, return true on successful parsing
